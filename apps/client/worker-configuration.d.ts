/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be51fabd28743408196c4a6875c3f76f)
...
declare namespace Cloudflare {
	...
	interface Env {
		AUTHORITY_ADDRESS: "JCapwSzWyHkjuVrT5ZTyKwBHzV9oYrTNhZguAMc9PiEc";
		COLLECTION_ADDRESS: "w44WvLKRdLGye2ghhDJBxcmnWpBo31A1tCBko2G6DgW";
		RPC_URL: string;
		WS_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTHORITY_ADDRESS" | "COLLECTION_ADDRESS" | "RPC_URL" | "WS_URL">> {}
}

...
pub enum AppInstruction {
    ...
    #[account(0, writable, name="pool", desc = "The program derived address of the Pool account to create (seeds: ['floor_swap', collection])")]
    ...
    #[account(0, writable, name="pool", desc = "The program derived address of the Pool account to toggle (seeds: ['floor_swap', collection])")]
    #[account(1, signer, name="authority", desc = "The authority of the app")]
    SetActive { active: bool },

    // Updates the swap fee
    #[account(0, writable, name="pool", desc = "The program derived address of the Pool account (seeds: ['floor_swap', collection])")]
    #[account(1, signer, name="authority", desc = "The authority of the app")]
    SetFee { fee_amount: u64 },

    /// Performs a swap
    #[account(0, name="pool", desc = "The program derived address of the Pool account to toggle (seeds: ['floor_swap', collection])")]
    ...
    /// Deposits an asset
    #[account(0, name="pool", desc = "The PDA of the Pool account (seeds: ['floor_swap', collection])")]

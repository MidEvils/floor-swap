...
pub enum FloorSwapError {
    ...
    ExpectedMplCoreCollection = 0xB,
    /// 12 - Expected MPL Core Asset
    #[error("Expected MPL Core Asset")]
    ExpectedMplCoreAsset = 0xC,
    /// 13 - Invalid collection for asset
    #[error("Invalid collection for asset")]
    InvalidCollectionForAsset = 0xD,
    /// 14 - Invalid owner for asset
    #[error("Invalid owner for asset")]
    InvalidAssetOwner = 0xE,
    /// 15 - Pool inactive
    #[error("Pool inactive")]
    PoolInactive = 0xF,
}

impl From<FloorSwapError> for solana_program_error::ProgramError {
